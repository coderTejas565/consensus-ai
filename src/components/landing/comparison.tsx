      ...
      >
        ...
        >
          ...
          <p
            ...
            "
          >
            Compare multiple perspectives and get a clearer answer from one place.
          </p>
        </motion.div>
  ...
  return (
    ...
    >
      ...
      <p
        className={`
          mt-3
          ${positive ? "text-[#FFFFEB]/70" : "text-[#034F46]/70"}
        `}
      >
        {description}
      </p>
          ...
          >
            <div
              className={`
                ...
                justify-center
                rounded-full
                ${positive ? "bg-[#FFFFEB]/10" : "bg-[#034F46]/10"}
              `}
            >
              {positive ? (
            ...
            <p
              className={`
                text-base
                leading-relaxed
                ${positive ? "text-[#FFFFEB]/90" : "text-[#034F46]/80"}
              `}
            >
              {item}
            </p>
